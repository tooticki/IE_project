...
-- (1749.99mm,-559.84mm)
;
\node [black] at (20.00mm,-395.64mm) { $f_1$ };
\node [black] at (90.00mm,-247.64mm) { $f_2$ };
\node [black] at (160.00mm,-71.64mm) { $f_3$ };
\node [black] at (256.00mm,96.36mm) { $f_4$ };
\node [black] at (500.00mm,628.36mm) { $f_n$ };
\node [black] at (12.00mm,-660mm) { $X$ };
\node [black] at (272.00mm,-660.64mm) { $X$ };
\node [black] at (488.00mm,-660.64mm) { $X$ };
\node [black] at (736.00mm,-660.64mm) { $X$ };
\node [black] at (1024.00mm,-660.64mm) { $X$ };
\node [black] at (1736.00mm,-660.64mm) { $X$ };
\node [black] at (848.00mm,1100mm) { $\lambda$ };
\end{scope}
\end{tikzpicture}
